...
writer = SummaryWriter('./log/{}/{}_v{}_{}{}_{}_layer{}_pre{}/'.format(args.att,args.d,args.v,args.att,args.c,args.count,args.l,args.pre))
...
for epoch in tqdm(range(args.e)):
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        reg_loss=reg2*torch.sum(torch.pow(Coef,2))
        ssc_loss=0.5*reg1*crition(z_conv,z_ssc)
