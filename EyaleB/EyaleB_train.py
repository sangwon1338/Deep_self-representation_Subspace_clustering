...
parser.add_argument('--reg1', type=int, default=150, metavar='N',help='input batch size for training (default: 64)')
...
alpha = max(0.4 - (38-1)/10 * 0.1, 0.1)
reg1 =  1.0 * 10 ** (38 / 10.0 - 2.0) 
reg2 = args.reg2
print(reg1)
writer = SummaryWriter('./log/{}/{}/{}_v{}_{}{}_{}_layer{}_pre{}/'.format(args.att,args.c,args.d,args.v,args.att,args.c,args.count,args.l,args.pre))


data_path ='./data/YaleBCrop025.mat'

pretrain_model_PATH='./para/{}_v{}_{}{}_layer{}_pre{}.pth'.format(args.d,args.v,args.att,args.c,args.l,args.pre)

if args.d=="EyaleB" and args.c==50 and args.l==3 and args.att == "base":
    model = EyaleB_v1_base50_layer3(True).cuda()
if args.d=="EyaleB" and args.c==25 and args.l==3 and args.att == "sofmax" and args.v == 1:
    model = EyaleB_v1_sofmax25_layer3(True).cuda()
if args.d=="EyaleB" and args.c==50 and args.l==3 and args.att == "sofmax" and args.v == 1:
    model = EyaleB_v1_sofmax50_layer3(True).cuda()
if args.d=="EyaleB" and args.c==75 and args.l==3 and args.att == "sofmax" and args.v == 1:
    model = EyaleB_v1_sofmax75_layer3(True).cuda()
...
class ESmall_Dataset(Dataset):
    def __init__(self, transform, img,label):
        # Transforms
...
train_dataset=ESmall_Dataset(transform=transform,img=Img,label=Label)
    ...
    if (epoch +1) > 850:
        ...
        with torch.no_grad():
            ...
            for data in trainloader:
                ...
                y_x, CKSym_X = post_proC(C, args.num, 10, 3.5)
